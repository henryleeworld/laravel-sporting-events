					...
					<form action="{{ route('events.index') }}">
						<div class="form-row">
                            <div class="form-group col-md-2">
                                <input type="text" class="form-control my-2 my-lg-1 date" id="date_from" name="date_from" value="{{ old('date_from') }}" placeholder="{{ trans('sporting.date_from') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <input type="text" class="form-control my-2 my-lg-1 date" id="date_to" name="date_to" value="{{ old('date_to') }}" placeholder="{{ trans('sporting.date_to') }}">
                            </div>
                            <div class="form-group col-md-2">
                                    ...
                                    <div class="thumb-content">
                                        @if($event->photo)
                                            <a href="{{ route('events.show', $event) }}">
                                                <img class="card-img-top img-fluid" src="{{ $event->photo->thumb_front }}" alt="{{ trans('sporting.button.card_image_cap') }}">
                                            </a>
                                        @endif
                                    </div>
                                    <div class="card-body">
