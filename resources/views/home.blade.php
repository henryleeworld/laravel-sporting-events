		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="content-block">
					<h1>{{ trans('sporting.sports_events') }}</h1>
					<div class="short-popular-category-list text-center">
						<h2>{{ trans('sporting.popular_sports') }}</h2>
		...
		<div class="row">
			<div class="col-12">
				...
				<div class="section-title">
					<h2>{{ trans('sporting.all_sports') }}</h2>
				</div>
				<div class="row">
                    <!-- Category list -->
                                    ...
                                    <div class="thumb-content">
                                        @if($post->photo)
                                            <a href="{{ route('posts.show', $post) }}">
                                                <img class="card-img-top img-fluid" src="{{ $post->photo->thumb_front }}" alt="{{ trans('sporting.card_image_cap') }}">
                                            </a>
                                        @endif
                                    </div>
                                    <div class="card-body">
